 ...
 */
filesMake.prototype.singleApp = function(tree, dir, filesName, fileInfo) {
        ...
        case 'route':
            ...
            Object
                ...
                .forEach(el => {
                    ...
                    _router += `
           .when(routerLink.${controllerName}.src + '${params}', {
                template: ${name}Temp,
...
// 处理chainApp
filesMake.prototype.chainApp = function() {

};

module.exports = new filesMake();
